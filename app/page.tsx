  ...
  return <><Header/><main className="shell">
    ...
    <section aria-labelledby="categorias"><div className="section-title"><h2 id="categorias">Explora por categoría</h2><span>Más colecciones en camino</span></div>
      <div className="category-grid home-categories">
        <Link className="category-card" href="/mandalas"><span className="category-art"><img src="/mandalas/mandala-petalos-hojas.webp" alt="Mandala floral fácil en blanco y negro"/></span><span className="category-copy"><strong>Mandalas</strong><small>{mandalas.length} dibujos</small></span></Link>
