...
export const metadata: Metadata = { title: "Contacto", description: "Contacta con Dibulisto para consultas sobre sus dibujos y recursos imprimibles.", alternates: { canonical: "/contacto/" }, robots: { index: false, follow: true } };
