...
export const metadata: Metadata = { title: "Política de cookies", description: "Información sobre el uso de cookies en Dibulisto.", alternates: { canonical: "/cookies/" }, robots: { index: false, follow: true } };
